...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "simple_vec_dot_product.autotvin.dat"
	set constFileTvOut       "simple_vec_dot_product.autotvout.dat"
	set constFileHdlTvIn     "simple_vec_dot_product.autohdltvin.dat"
	set constFileHdlTvOut    "simple_vec_dot_product.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
