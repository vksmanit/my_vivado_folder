...
// wrapc file define: "a"
#define AUTOTB_TVIN_a  "../tv/cdatafile/c.simple_vec_dot_product.autotvin_a.dat"
// wrapc file define: "b"
#define AUTOTB_TVIN_b  "../tv/cdatafile/c.simple_vec_dot_product.autotvin_b.dat"
// wrapc file define: "out_r"
#define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.simple_vec_dot_product.autotvout_out_r.dat"
#define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.simple_vec_dot_product.autotvin_out_r.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "out_r"
#define AUTOTB_TVOUT_PC_out_r  "../tv/rtldatafile/rtl.simple_vec_dot_product.autotvout_out_r.dat"
...
extern "C" void simple_vec_dot_product (
int a[4],
int b[4],
int out[4]);

#define simple_vec_dot_product AESL_ORIG_DUT_simple_vec_dot_product
extern "C" void simple_vec_dot_product (
int a[4],
int b[4],
int out[4]);
...
int out[4])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *out_r_pc_buffer = new sc_bv<32>[4];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_r
				{
					...
					// {
						// celement: out(31, 0)
						// {
							sc_lv<32>* out_lv0_0_3_1 = new sc_lv<32>[4];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								{
									out_lv0_0_3_1[hls_map_index++].range(31, 0) = sc_bv<32>(out_r_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								if (&(out[0]) != NULL) // check the null address if the c port is array or others
								{
									out[i_0] = (out_lv0_0_3_1[hls_map_index++]).to_uint64();
								}
							}
						}
					}
	...
	else
	{
		...
		sc_bv<32>* out_r_tvin_wrapc_buffer = new sc_bv<32>[4];
...
// [call_c_dut] ---------->
		...
		AESL_ORIG_DUT_simple_vec_dot_product(a, b, out);
		...
		sc_bv<32>* out_r_tvout_wrapc_buffer = new sc_bv<32>[4];
