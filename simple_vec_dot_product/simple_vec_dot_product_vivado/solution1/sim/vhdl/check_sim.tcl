...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.simple_vec_dot_product.autotvin_a.dat"
         "c.simple_vec_dot_product.autotvin_b.dat"
         "c.simple_vec_dot_product.autotvin_out_r.dat"
         "c.simple_vec_dot_product.autotvout_out_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.simple_vec_dot_product.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
