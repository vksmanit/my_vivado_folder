...
if {[file isfile simple_vec_dot_product.autotvin.dat]} {
	file delete -force simple_vec_dot_product.autotvin.dat
}

if {[file isfile simple_vec_dot_product.autotvout.dat]} {
	file delete -force simple_vec_dot_product.autotvout.dat
}
