...
$(ObjDir)/multiplication_tb.c_pre.c.tb.o : multiplication_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) multiplication_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/rt_nonfinite.c_pre.c.tb.o : rt_nonfinite.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) rt_nonfinite.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/rtGetNaN.c_pre.c.tb.o : rtGetNaN.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) rtGetNaN.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/rtGetInf.c_pre.c.tb.o : rtGetInf.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) rtGetInf.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/multiplication_terminate.c_pre.c.tb.o : multiplication_terminate.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) multiplication_terminate.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/multiplication_initialize.c_pre.c.tb.o : multiplication_initialize.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) multiplication_initialize.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/multiplication.c_pre.c.tb.o : multiplication.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) multiplication.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
