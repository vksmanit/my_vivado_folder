...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "multiplication.autotvin.dat"
	set constFileTvOut       "multiplication.autotvout.dat"
	set constFileHdlTvIn     "multiplication.autohdltvin.dat"
	set constFileHdlTvOut    "multiplication.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
