...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/multiplication.a
...
MATLAB_BIN                = /home/vipinsoni/MATLAB/bin
MATLAB_ARCH_BIN           = /home/vipinsoni/MATLAB/bin/glnxa64
MASTER_ANCHOR_DIR         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/multiplication.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/multiplication -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=multiplication -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/codegen/lib/multiplication/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/multiplication/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
