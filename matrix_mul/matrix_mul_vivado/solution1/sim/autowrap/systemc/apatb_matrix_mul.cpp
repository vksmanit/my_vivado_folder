...
#define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.matrix_mul.autotvout_out_r.dat"
#define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.matrix_mul.autotvin_out_r.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "out_r"
#define AUTOTB_TVOUT_PC_out_r  "../tv/rtldatafile/rtl.matrix_mul.autotvout_out_r.dat"
...
extern "C" void matrix_mul (
double a[4],
double b[4],
double out[4]);

#define matrix_mul AESL_ORIG_DUT_matrix_mul
extern "C" void matrix_mul (
double a[4],
double b[4],
double out[4]);
...
double out[4])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<64> *out_r_pc_buffer = new sc_bv<64>[4];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_r
				{
					...
					// {
						// celement: out(63, 0)
						// {
							sc_lv<64>* out_lv0_0_3_1 = new sc_lv<64>[4];
						// }
					// }
					...
					// bitslice(63, 0)
					{
						...
						// celement: out(63, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								{
									out_lv0_0_3_1[hls_map_index++].range(63, 0) = sc_bv<64>(out_r_pc_buffer[hls_map_index].range(63, 0));
								}
							}
						}
					}
					...
					// bitslice(63, 0)
					{
						...
						// celement: out(63, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								// output_type_conversion : (out_lv0_0_3_1[hls_map_index++]).to_uint64()
								if (&(out[0]) != NULL) // check the null address if the c port is array or others
								{
									*(long long*)&out[i_0] = (out_lv0_0_3_1[hls_map_index++]).to_uint64();
								}
							}
						}
					}
	...
	else
	{
		...
		sc_bv<64>* a_tvin_wrapc_buffer = new sc_bv<64>[4];
		...
		sc_bv<64>* b_tvin_wrapc_buffer = new sc_bv<64>[4];
		...
		sc_bv<64>* out_r_tvin_wrapc_buffer = new sc_bv<64>[4];
				...
				// celement: out(63, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 3; i_0 += 1)
					{
						...
						if (&(out[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							out_r_tvin_wrapc_buffer[hls_map_index++].range(63, 0) = out_tmp_mem.range(63, 0);
						}
					}
				}
			}
		...
		tcl_file.set_num(4, &tcl_file.out_r_depth);
...
// [call_c_dut] ---------->
		...
		AESL_ORIG_DUT_matrix_mul(a, b, out);
		...
		sc_bv<64>* out_r_tvout_wrapc_buffer = new sc_bv<64>[4];
