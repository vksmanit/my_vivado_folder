...
$(ObjDir)/matrix_mul_tb.c_pre.c.tb.o : matrix_mul_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) matrix_mul_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/matrix_mul.c_pre.c.tb.o : matrix_mul.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) matrix_mul.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/matrix_mul_initialize.c_pre.c.tb.o : matrix_mul_initialize.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) matrix_mul_initialize.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/matrix_mul_terminate.c_pre.c.tb.o : matrix_mul_terminate.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) matrix_mul_terminate.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
